...
public class NewsDE {
    ...
    public int getImage_layout() {
        return image_layout;
    }

    public void setImage_layout(int image_layout) {
    ...
    public int getTicheng_point() {
        return ticheng_point;
    }

    public void setTicheng_point(int ticheng_point) {
        this.ticheng_point = ticheng_point;
    }
